...
<?php
	...
	$r_name=mysqli_real_escape_string($link,$_REQUEST['r_name']);
	$user_Id=mysqli_real_escape_string($link,$_REQUEST['user_Id']);
	$r_email=mysqli_real_escape_string($link,$_REQUEST['r_email']);
	$r_contact=mysqli_real_escape_string($link,$_REQUEST['r_contact']);
	$r_password=mysqli_real_escape_string($link,$_REQUEST['r_password']);
	$r_blood_group=mysqli_real_escape_string($link,$_REQUEST['r_blood_group']);
	$r_blood_amount=mysqli_real_escape_string($link,$_REQUEST['r_blood_amount']);
	$r_delivary_date=mysqli_real_escape_string($link,$_REQUEST['r_delivary_date']);
	$r_location=mysqli_real_escape_string($link,$_REQUEST['r_location']);
...
//insert value into cv table
	 $sql = "INSERT INTO request (r_name,user_Id,r_email,r_contact,r_password,r_blood_group,r_blood_amount,r_delivary_date,r_location)
	 VALUES ( '$r_name','$user_Id','$r_email','$r_contact','$r_password','$r_blood_group','$r_blood_amount','$r_delivary_date','$r_location')";
